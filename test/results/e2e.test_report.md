...
**Execution Date:** Sat, 25 Jul 2026 04:59:44 GMT
...
| :--- | :--- | :--- | :---: | :--- |
| AuthModule | `POST /auth/register` | should reject invalid payload (400) | 🟩 PASS | 111ms |
...
| AuthModule | `POST /auth/login` | should reject invalid payload (400) | 🟩 PASS | 69ms |
| AuthModule | `POST /auth/login` | should not log in with invalid credentials and return 401 | 🟩 PASS | 133ms |
| AuthModule | `POST /auth/login` | should log in a user and return tokens | 🟩 PASS | 138ms |
| AuthModule | `GET /auth/me` | should reject unauthenticated requests | 🟩 PASS | 131ms |
| AuthModule | `GET /auth/me` | should get user profile | 🟩 PASS | 137ms |
| AuthModule | `POST /auth/refresh` | should reject unauthenticated requests | 🟩 PASS | 136ms |
| AuthModule | `POST /auth/refresh` | should refresh tokens | 🟩 PASS | 136ms |
...
| DssModule | `/dss ➔ PUT /dss/weights` | should update weights | 🟩 PASS | 22ms |
...
| DssModule | `/dss ➔ GET /dss/runs/lastest` | should retrieve the latest run | 🟩 PASS | 19ms |
...
| DssModule | `/dss ➔ DELETE /dss/runs/details/:id` | should delete a run detail | 🟩 PASS | 6ms |
...
| BuildingModule | `/buildings ➔ GET /buildings` | should retrieve all buildings | 🟩 PASS | 21ms |
| BuildingModule | `/buildings ➔ PUT /buildings/:id` | should reject unauthenticated requests | 🟩 PASS | 6ms |
| BuildingModule | `/buildings ➔ PUT /buildings/:id` | should update the building | 🟩 PASS | 9ms |
...
| BuildingModule | `/buildings ➔ POST /buildings/:code/assessments` | should create an assessment | 🟩 PASS | 6ms |
...
| BuildingModule | `/buildings ➔ PUT /buildings/:code/assessments/:assessmentId` | should update an assessment | 🟩 PASS | 8ms |
...
| BuildingModule | `/buildings ➔ DELETE /buildings/:id` | should delete the building | 🟩 PASS | 3ms |
